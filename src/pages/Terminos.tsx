...
export default function Terminos() {
  ...
  return (
    <Layout>
      <PageHero title="Términos y Condiciones" subtitle="Última actualización: Junio 2026" image="" />
      <section className="py-20 md:py-28 bg-background-100">
        <div className="w-full px-6 md:px-12">
          <div className="max-w-3xl mx-auto space-y-6 text-base font-body text-foreground-600 leading-relaxed">
            <p>El acceso y uso de este sitio web implica la aceptación de los presentes términos y condiciones de EMPRENOR GROUP.</p>
            ...
            <p>Todos los contenidos, marcas, logotipos y diseños son propiedad de EMPRENOR GROUP y están protegidos por las leyes de propiedad intelectual vigentes.</p>
            ...
            <p>EMPRENOR GROUP puede actualizar estos términos en cualquier momento. Las modificaciones entrarán en vigencia desde su publicación en este sitio.</p>
          </div>
        </div>
      </section>
    </Layout>
